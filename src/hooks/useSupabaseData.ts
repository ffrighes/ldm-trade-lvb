...
export function useAddMaterial() {
  ...
  return useMutation({
    mutationFn: async (m: { descricao: string; bitola: string; unidade: string; custo: number }) => {
...
export function useUpdateMaterial() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async ({ id, ...data }: { id: string; descricao?: string; bitola?: string; unidade?: string; custo?: number }) => {
