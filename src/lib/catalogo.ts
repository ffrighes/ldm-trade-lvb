...
export const CATALOG_FITTINGS: CatalogItemFitting[] = [
  ...
  // ── Válvulas ─────────────────────────────────────────────────────────────────
  { id: 'valv-gaveta-aberta',    categoria: 'valvula', subtipo: 'gaveta_aberta',    label: 'Válvula gaveta — aberta',                 k: 0.17, confianca: 'alta',  fonte: 'Neutrium (Crane TP-410)', fonteUrl: NEUTRIUM_URL },
  { id: 'valv-gaveta-meio',      categoria: 'valvula', subtipo: 'gaveta_meio',      label: 'Válvula gaveta — ½ aberta',               k: 4.50, confianca: 'media', fonte: 'Neutrium (Crane TP-410)', fonteUrl: NEUTRIUM_URL },
  ...
  { id: 'valv-angular-aberta',   categoria: 'valvula', subtipo: 'angular_aberta',   label: 'Válvula angular — aberta',                k: 2.00, confianca: 'media', fonte: 'Neutrium (Crane TP-410)', fonteUrl: NEUTRIUM_URL },
  ...
  { id: 'valv-pe',               categoria: 'valvula', subtipo: 'valvula_pe',       label: 'Válvula de pé',                           k: 15.0, confianca: 'baixa', fonte: 'Neutrium (Crane TP-410)', fonteUrl: NEUTRIUM_URL },
  // ── Acessórios ───────────────────────────────────────────────────────────────
