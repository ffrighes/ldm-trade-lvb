...
const CONSOLIDATED_TABLE_STYLES = {
  ...
  columnStyles: {
    ...
    2: { cellWidth: 70, halign: 'center' as const },
    3: { cellWidth: 50, halign: 'center' as const },
    4: { cellWidth: 45, halign: 'center' as const },
    5: { cellWidth: 65, halign: 'center' as const, overflow: 'ellipsize' as const },
    6: { cellWidth: 85 },
  },
...
const DETAIL_TABLE_STYLES = {
  ...
  columnStyles: {
    ...
    6: { cellWidth: 55, halign: 'center' as const, overflow: 'ellipsize' as const },
    7: { cellWidth: 85 },
  },
  margin: { top: MARGIN_TOP, bottom: MARGIN_BOTTOM, left: MARGIN_LEFT, right: MARGIN_RIGHT },
};
